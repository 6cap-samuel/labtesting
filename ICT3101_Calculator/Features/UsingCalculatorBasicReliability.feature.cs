...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("CalculateFaultin")]
        [NUnit.Framework.CategoryAttribute("Reliability")]
        public virtual void CalculateFaultin()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("CalculateFaultin", null, new string[] {
                        "Reliability"});
#line 7
